export const countries = [
   {  name:"", fullname: "Choose a currency"},
   {  name:"AUD", fullname: "Australian dollar"},
   {  name:"BGN", fullname: "Bulgarian lev"},
   {  name:"BRL", fullname: "Brazilian real"},
   {  name:"CAD", fullname: "Canadian dollar"},
   {  name:"CHF", fullname: "Swiss franc"},
   {  name:"CNY", fullname: "Chinese yuan renminbi"},
   {  name:"CZK", fullname: "Czech koruna"},
   {  name:"DKK", fullname: "Danish krone"},
   {  name:"EUR", fullname: "Euro Member Countries"},
   {  name:"GBP", fullname: "Pound sterling"},
   {  name:"HKD", fullname: "Hong Kong dollar"},
   {  name:"HRK", fullname: "Croatian kuna"},
   {  name:"HUF", fullname: "Hungarian forint"},
   {  name:"IDR", fullname: "Indonesian rupiah"},
   {  name:"ILS", fullname: "Israeli shekel"},
   {  name:"INR", fullname: "Indian rupee"},
   {  name:"JPY", fullname: "Japanese yen"},
   {  name:"KRW", fullname: "South Korean won"},
   {  name:"MXN", fullname: "Mexican peso"},
   {  name:"MYR", fullname: "Malaysian ringgit"},
   {  name:"NOK", fullname: "Norwegian krone"},
   {  name:"NZD", fullname: "New Zealand dollar"},
   {  name:"PHP", fullname: "Philippine peso"},
   {  name:"PLN", fullname: "Polish zloty"},
   {  name:"RON", fullname: "Romanian leu"},
   {  name:"RUB", fullname: "Russian rouble"},
   {  name:"SEK", fullname: "Swedish krona"},
   {  name:"SGD", fullname: "Singapore dollar"},
   {  name:"THB", fullname: "Thai baht"},
   {  name:"TRY", fullname: "Turkish lira"},
   {  name:"USD", fullname: "US dollar"},
   {  name:"ZAR", fullname: "South African rand"}
];
